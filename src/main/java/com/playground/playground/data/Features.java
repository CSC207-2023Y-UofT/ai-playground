...
public class Features {
     ...
     * for Example: [ [[x_0, y_0], 0], [[x_1, y_1], 1], [[x_2, y_2], 0], [[x_3, y_3], 1] ]
     ...
     * @return The same dataset with sin applied to the correct axis values appended to the correct coordinates list
     */
