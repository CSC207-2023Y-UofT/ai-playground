...
class NeuralNetBuilderTest {
    ...
    void testOptimizationAlgorithm() {
        ...
        assertEquals(OptimizationAlgorithm.LINE_GRADIENT_DESCENT, builder.buildNeuralNet().getOptimizationAlgorithm());
    }
    ...
    void testLossFunction() {
        ...
        assertEquals(LossFunctions.LossFunction.COSINE_PROXIMITY, builder.buildNeuralNet().getLossFunction());
    }
