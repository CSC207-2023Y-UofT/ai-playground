...
/**
 * Test class to validate the functionality of ClusterDatasetGenerator.
 * This test class ensures 100% test coverage of the ClusterDatasetGenerator class.
 */
public class ClusterDatasetGeneratorTest {
    ...
    /**
     * Test the generateCluster method of ClusterDatasetGenerator with specified parameters.
     * This test case ensures that the generateCluster method generates clusters correctly with provided parameters.
     */
    @Test
    public void testGenerateCluster() {
        ...
        ArrayList<ArrayList<Double>> cluster = ClusterDatasetGenerator.generateCluster(
                centerX, centerY, stdDeviation, size, noise);
