...
/**
 * The {@code DatasetType} enum represents different types of datasets that can be generated.
 * Each dataset type corresponds to a specific pattern or distribution of data points.
 */
public enum DatasetType {
    ...
    /**
     * Represents a quadrant dataset where data points are distributed in the first and third quadrants.
     */
    QUADRANT,
