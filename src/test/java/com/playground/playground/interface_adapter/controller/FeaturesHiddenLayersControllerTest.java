...
/**
 * Test class for FeaturesHiddenLayersController.
 * This class provides JUnit tests for methods in the FeaturesHiddenLayersController that don't directly interact with JavaFX components.
 */
class FeaturesHiddenLayersControllerTest {
    ...
    /**
     * Test for the setNumHiddenLayers method.
     * Tests if the number of hidden layers is correctly set.
     */
    @Test
    ...
    /**
     * Test for the setLayersNeurons method.
     * Tests if the neurons in each layer are correctly set.
     */
    @Test
