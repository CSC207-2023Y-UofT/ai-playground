...
public class ModelTrainingServicesTest {
    ...
    public void testModelTrainingServicesConstructor() {
        ...
        // When
        ModelTrainingServices service = new ModelTrainingServices(trainingData, model, statsFileName, testData);
        // Then
...
//  Just some code to compute the labels
    ...
    public void testTrainModel() {
        ...
        ModelTrainingServices service = new ModelTrainingServices(trainingData, model, "test_stats_file", testData);
