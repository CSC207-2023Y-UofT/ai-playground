...
public class ClusterDatasetGenerator implements DatasetGenerator {
    ...
    public ArrayList<ArrayList<ArrayList<Double>>> generate(int noise) {
        ...
        ArrayList<ArrayList<Double>> cluster1 = generateCluster(cluster1CenterX, cluster1CenterY,
                cluster1StdDeviation, cluster1Size, noise);
        ...
        ArrayList<ArrayList<Double>> cluster2 = generateCluster(cluster2CenterX, cluster2CenterY,
                cluster2StdDeviation, cluster2Size, noise);
