...
public class Features {
  ...
  /**
   * Helper function to build a 2D array with the squared (or transformed) values and the other
   * values in the correct order (based on the provided axis), and adds it to the dataset.
   *
   ...
   * @param squaredData the 2D array that contains the squared (or transformed) values and other
   *     values
   ...
   */
  private static void buildAxisArray(
      int axis,
      ArrayList<ArrayList<ArrayList<Double>>> squaredDataset,
      ArrayList<ArrayList<Double>> squaredData,
      ArrayList<Double> otherValues,
   ...
   */
  public static ArrayList<ArrayList<ArrayList<Double>>> squareVal(
      ArrayList<ArrayList<ArrayList<Double>>> dataset, int axis) {
   ...
   * @return a new dataset with the sin function applied to the values of the correct axis and the
   *     other axis unchanged
   */
  public static ArrayList<ArrayList<ArrayList<Double>>> sinVal(
      ArrayList<ArrayList<ArrayList<Double>>> dataset, int axis) {
   ...
   */
  public static ArrayList<ArrayList<ArrayList<Double>>> multiplyVal(
