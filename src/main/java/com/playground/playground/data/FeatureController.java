...
public class FeatureController {
   ...
   * 'circular' 'cluster' 'quadrant' 'spiral' The 2nd parameter String featureName; represents which
   * feature has been just been selected by the user square 'squareX' 'squareY' 'XtimesY' 'sinX'
   * 'sinY' The 3rd parameter Integer noise; represents the noise in the dataset
   */
  public static ArrayList<ArrayList<ArrayList<Double>>> addTrainingData(
      String dataName, String featureName, int noise) {
  ...
  public static ArrayList<ArrayList<ArrayList<Double>>> applyFeature(
      String featureName, ArrayList<ArrayList<ArrayList<Double>>> dataset) {
