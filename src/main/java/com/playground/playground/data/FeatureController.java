...
public class FeatureController {
        ...
        /**
         *
         * Creates a dataset for the training data. It applies all the features given by the user to create a single
         * dataset in the correct format for training.
         *
         ...
         * @return dataset in Neural Net configuration containing original x and y values, and all applicable features
         */
