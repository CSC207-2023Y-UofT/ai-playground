...
/**
 * A datasets processor that takes a dataset generator as input and processes the generated
 * datasets. The DataProcessor applies a transformation on the generated datasets using the
 * TransformDatasets class.
 */
public class DataProcessor {
   ...
   * @return An ArrayList containing ArrayLists representing the transformed datasets. Each inner
   *     ArrayList contains two objects: a List containing x and y coordinates of the datasets
   *     points, and an Integer representing a weight or label for the dataset.
   */
