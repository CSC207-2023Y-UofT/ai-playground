...
/**
 * Test class to validate the functionality of CircularDatasetGenerator. This test class ensures
 * 100% test coverage of the CircularDatasetGenerator class.
 */
public class CircularDatasetGeneratorTest {

  /**
   * Test the generate method of CircularDatasetGenerator to ensure it generates circular clusters
   * correctly.
   */
  @Test
  ...
  /**
   * Test the generate method of CircularDatasetGenerator with noise set to zero. This test case
   * ensures that clusters are generated without additional noise.
   */
  @Test
