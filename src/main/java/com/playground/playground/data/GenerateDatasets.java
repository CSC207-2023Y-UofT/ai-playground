...
/**
 * A utility class for generating datasets for testing machine learning algorithms. The datasets are
 * designed to represent different patterns such as circular clusters, cluster patterns, quadrant
 * datasets, and spiral datasets.
 */
public class GenerateDatasets {
   ...
   *     y-coordinates) representing the cluster.
   */
